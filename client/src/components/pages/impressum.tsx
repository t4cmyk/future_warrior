  ...
  return (
    <>
      ...
      <Container>
        ...
        <br />
        <h2>Bildquellen</h2>
        Die verwendeten Stand- und Bewegtbildaufnahmen stammen aus eigener
        Produktion. Als Urheber sieht sich demnach dis[Positiv!] in der
        Verantwortung, Verletzungen gegen das Urheberrecht entsprechend zu
        verfolgen.
        <br />
        <h2>Tonquellen</h2>
