...
export function Privacy() {
  return (
    <>
      ...
      <br />
      <Container>
        Rebecca Zechiel agiert unter dem Namen dis[Positiv!] als freiberufliche
        Künstlerin, welche dem Datenschutz verpflichtet ist. Im Folgenden möchte
        ich dich mit den Verfahren der Erhebung, Verwendung und Übermittlung von
        Informationen auf dieser Website vertraut machen.
        <br />
        ...
        Websitebetreiber. Dessen Kontaktdaten kannst du dem Impressum dieser
        Website entnehmen.
        <br />
        <br />
        <h3>Wie erfassen wir deine Daten?</h3>
        Zum einen werden deine Daten erhoben, indem du sie direkt mitteilst,
        z.B. durch ein Kontaktformular. Andere Daten werden automatisch beim
        Website-Besuch durch die IT-Systeme erfasst, vor allem technische Daten.
        <br />
        <br />
        <h3>Wofür nutzen wir deine Daten?</h3>
        Alle Daten, die wir erheben, werden ausschließlich zur Gewährleistung
        der fehlerfreien Bereitstellung der Website verwendet.
        <br />
        <br />
        <h3>Welche Rechte hast du bezüglich deiner Daten?</h3>
        ...
        Thema Datenschutz kannst du dich jederzeit unter der im Impressum
        angegebenen Adresse an uns wenden. Des Weiteren steht dir ein
        Beschwerderecht bei der zuständigen Aufsichtsbehörde zu. Außerdem hast
        du das Recht, unter bestimmten Umständen die Einschränkung der
        Verarbeitung deiner personenbezogenen Daten zu verlangen. Details hierzu
        entnimmst du der Datenschutzerklärung unter „Recht auf Einschränkung der
        Verarbeitung“.
        <br />
        <br />
        <h2>2. Allgemeine Hinweise und Pflichtinformationen</h2>
        Die Betreiberin der Website nimmt den Schutz deiner persönlichen Daten
        sehr ernst. Wir behandeln deine personenbezogenen Daten vertraulich und
        entsprechend der gesetzlichen Datenschutzvorschriften sowie dieser
        Datenschutzerklärung.
        <br />
        Wenn du diese Website benutzt, werden verschiedene personenbezogene
        Daten erhoben. Personenbezogene Daten sind Daten, mit denen du
        persönlich identifiziert werden kannst. Die vorliegende
        ...
        Rebecca Zechiel
        <br />
        Annenstraße 25a, 31134 Hildesheim
        <br />
        ...
        Datenschutzerklärung. Wenn du Widerspruch einlegst, werden wir Ihre
        ...
        deine personenbezogenen Daten verarbeitet, um Direktwerbung zu
        ...
        es mit solcher Direktwerbung in Verbindung steht. Wenn du widersprichst,
        werden deine personenbezogenen Daten anschließend nicht mehr zum Zwecke
        ...
        vertraulicher Inhalte, wie zum Beispiel Anfragen, die du an uns als
        Seitenbetreiber sendest, eine SSL-bzw. TLSVerschlüsselung. Eine
        ...
        in deiner Browserzeile. Wenn die SSL- bzw. TLS-Verschlüsselung aktiviert
        ist, können die Daten, die du an uns übermittelst, nicht von Dritten
        mitgelesen werden.
        <br />
        <br />
        ...
        personenbezogenen Daten zu verlangen. Hierzu kannst du dich jederzeit
        ...
        <ul>
          ...
          <li>
            Wenn du einen Widerspruch nach Art. 21 Abs. 1 DSGVO eingelegt hast,
            muss eine Abwägung zwischen deinen und unseren Interessen
            vorgenommen werden. Solange noch nicht feststeht, wessen Interessen
            überwiegen, hast du das Recht, die Einschränkung der Verarbeitung
        ...
        <br />
        <h3>Cookies</h3>
        Diese Website verwendet so genannte Cookies. Cookies richten auf deinem
        ...
        machen. Cookies sind kleine Textdateien, die auf deinem Rechner abgelegt
        werden und die dein Browser speichert.
        <br />
        ...
        oder zur Bereitstellung bestimmter, von dir erwünschter Funktionen
        ...
        Analyse deines Surfverhaltens) gespeichert werden, werden diese in
        ...
        somit ausschließlich auf Grundlage deiner Einwilligung (Art. 6 Abs. 1
        lit. a DSGVO). Du kannst diese Einwilligung jederzeit widerrufen. Dazu
        ...
        Widerruf unberührt. Die von dir im Kontaktformular eingegebenen Daten
        verbleiben bei uns, bis du uns zur Löschung aufforderst, Ihre
        ...
        und verarbeitet. Diese Daten geben wir nicht ohne deine Einwilligung
        weiter.
        <br />
        ...
        deiner Einwilligung (Art. 6 Abs. 1 lit. a DSGVO) und / oder auf unseren
